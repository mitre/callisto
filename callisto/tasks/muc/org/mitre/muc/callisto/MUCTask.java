...
// don't use these here -- they're MAT-specific
 ...
 * to reside.
 */
public class MUCTask extends AbstractTask {
  ...
  private static final String TASK_TITLE = "MUC Task";
  private static final String TASK_NAME = "org.mitre.muc";
  private static final String TASK_VERSION = "1.3";
  private static final String TASK_DESCRIPTION =
  "MUC - \"Message Understanding Conference\" Task defines a simple annotation task with ENAMEX, TIMEX and NUMEX tags.";
  private static final String MAIA_SCHEME =
  "http://callisto.mitre.org/maia/MUC.maia.xml";
  private static final String LOCAL_MAIA_SCHEME = "/resource/MUC.maia.xml";
  ...
  private void initIO () {
    //ImportMUC (this)};
    importers = new Importer[] {new DefaultInlineImporter(this, "MUC SGML")};
    exporters = new Exporter[] {new DefaultInlineExporter(this, "MUC SGML")};
  }
