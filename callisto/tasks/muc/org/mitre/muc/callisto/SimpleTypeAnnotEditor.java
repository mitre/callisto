...
public class SimpleTypeAnnotEditor extends JPanel implements JawbComponent {
  ...
  private static final String[] OTHER_ATTRIB = new String[] {"TextExtent"};
  private static final String[] OTHER_HEADING = new String[] {"Text"};
    ...
    if (filterTypes != null) {
      ...
      for (int i=0; i<filterTypes.length; i++) {
        if (filterTypes[i] == null) {
          ...
          typeCombo.addItem (new MyAttributeValueFilter ("type",
                                                         filterTypes[i]));
        }
      }
      ...
      atm = new AnnotationTableModel (task, type, OTHER_ATTRIB, OTHER_HEADING);
    }
