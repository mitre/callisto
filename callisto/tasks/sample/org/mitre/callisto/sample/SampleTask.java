...
public class SampleTask extends AbstractTask {
  ...
  private static final String TASK_TITLE = "Sample";
  private static final String TASK_NAME = "org.mitre.sample";
  private static final String TASK_VERSION = "1.0";
  private static final String TASK_DESCRIPTION =
    "Sample Callisto Task to show how to package Task plugins.";
  private static final String MAIA_SCHEME =
    "http://callisto.mitre.org/maia/Sample.maia.xml";
  private static final String LOCAL_MAIA_SCHEME = "/resource/Sample.maia.xml";
  ...
  public String getHighlightKey (AWBAnnotation annot, Object constraint) {
    if (annot.getAnnotationType().getName().equals ("tag"))
  ...
  private void initializeClassMap() {
    ...
    annotationClass.put(getAnnotationType ("tag"),
                        PhraseTaggingAnnotation.class);
  }

  /** used several times, so I made them constants */
  private static final String[] STYLE_KEYS = {"NP", "VP"};
  private static final String[] COLORS = {"#ffffcc","#ccffcc"};
