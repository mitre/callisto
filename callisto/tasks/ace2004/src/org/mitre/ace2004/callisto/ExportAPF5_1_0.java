...
public final class ExportAPF5_1_0 implements Exporter {

  private static final String APF_VERSION = "5.1.0";

  private static final int DEBUG = 0;

  public ExportAPF5_1_0() {
    super();
  }
...
// Exporter
  ...
  private void addArgumentList(Element parent, Element mention,
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_0 addArgumentList parent mention "
			     + parent + " " + mention);
      }
    ...
    while (iter.hasNext()) {
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_0 next = " + next);
      }
	...
	next = ((AnnotationRef) next).getElement();
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_0 aceArgument = " + aceArgument);
      }
      String role = toString(aceArgument.getAttributeValue("role"));
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_0 role = " + role);
      }
      ...
      String type;
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_0 value = " + value);
      }
      if (value == null || role == null) {
