...
public final class ExportAPF5_1_1a implements Exporter {

  private static final String APF_VERSION = "5.1.1a";
...
// Exporter
  ...
  public String getDescription () {
    return "Saves the selected file in APF v"+APF_VERSION+" format.  Recognizes the new 'CAL' attribute for TIMEX2";
  }
  ...
  private void addArgumentList(Element parent, Element mention,
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_1a addArgumentList parent mention "
			     + parent + " " + mention);
      }
    ...
    while (iter.hasNext()) {
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_1a next = " + next);
      }
	...
	next = ((AnnotationRef) next).getElement();
      ...
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_1a aceArgument = " + aceArgument);
      }
      String role = toString(aceArgument.getAttributeValue("role"));
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_1a role = " + role);
      }
      ...
      String type;
      if (DEBUG > 0) {
	  System.err.println("Export.APF5_1_1a value = " + value);
      }
      if (value == null || role == null) {
