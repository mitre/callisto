...
class AnnotationIdTableCellRenderer extends DefaultTableCellRenderer {
  ...
  public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
    if (value != null && value instanceof AWBAnnotation) {
      ...
      String label = String.valueOf(annot.getAttributeValue("id"));
      
      if (annot instanceof TextExtentRegion) {
        label += ": " + ((TextExtentRegion)annot).getTextExtent();
      }
