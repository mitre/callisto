...
public class ImportTIMEX2NoAttrVals implements Importer {
  ...
  public ImportTIMEX2NoAttrVals (Task t) {
    task = t;
  }

  public String getFormat () {
    return "TIMEX2 SGML Stripped";
  }
  ...
  public String getDescription () {
    return "Accepts SGML, strips all attribute values out of the TIMEX2 tags, and maintains unrecognized tags in an SGML structure.";
  }
  ...
  public AWBDocument importDocument (URI uri, String encoding)
    ...
    if (DEBUG > 0)
      System.err.println("ImportTimex2NoAttrVals: entering...\n  " + uri);
	...
	// Don't copy any attributes -- this importer strips them by choice
