 ...
 * 
 * @deprecated Renamed to SgmlDocument. This class will be removed in a future
 * version.
 */
public class ParseSgml extends SgmlDocument {

  /** Create an empty sgml document. */
  public ParseSgml (String text) {
    super (text, 0);
  }
  
  /** Create an empty sgml document with debugging turned on. */
  public ParseSgml (String text, int debugLevel) {
    super (text, debugLevel);
  }
  
  public ParseSgml (Reader in) throws IOException {
    super (in, 0);
  }
  
  public ParseSgml (Reader in, int debugLevel) throws IOException {
    super (in, debugLevel);
  }
}
