...
/** 
 * Annotation subtypes that have sets of subordinate Annotations should
 * implement this interface.  
 */
public interface HasSubordinates extends AWBAnnotation {

    /**
     * Returns a list of keys for subordinates of an annotation. 
     */
    AnnotationType[] getSubordinateTypes ();

    /** 
     * Returns the array of subordinates of the specified type. 
     */
    AWBAnnotation[] getSubordinates (AnnotationType subType);
     ...
     */
    boolean addSubordinates (AWBAnnotation[] subords);

    /**
     * Add a single subordinate to the set of the appropriate type.
     * The type is automatically derived from the AWBAnnotation passed
     * in, and thus need not be passed in explicitly.
     *
     * might need to throw the same exceptions as addSubordinates
     */
    boolean addSubordinate (AWBAnnotation subord);
     ...
     * false otherwise.
     */
    boolean removeSubordinates (AWBAnnotation[] subords);
     ...
     */
    boolean removeSubordinate (AWBAnnotation subord);
     ...
     *  Returns true if successful; false otherwise.
     */
    boolean clearSubordinates (AnnotationType subType);
}
