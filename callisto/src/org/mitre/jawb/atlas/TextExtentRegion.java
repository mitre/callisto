 ...
 * provide "TextExtent", "TextExtentStart" & "TextExtentEnd"
 * attributes, though setAttribute("TextExtent", "whatever"); should
 * throw an ImmodifiableAttributeException - FIXME
 */
public interface TextExtentRegion extends AWBAnnotation {

  /** Region text key */
  public static final String TEXT_EXTENT = "TextExtent";

  /** Region start,end key */
  public static final String TEXT_EXTENTS = "TextExtents";
  ...
  public static String UNSPECIFIED_STRING = "-1";
     ...
     */
    String getTextExtent ();

    /**
     * Returns the integer offset of this Annotation's text-extent
     * region's start anchor.
     */
    int getTextExtentStart ();

    /**
     * Sets the integer offset of this Annotation's text-extent
     * region's start anchor to the given value.
     * Returns true if the operation was successful, false otherwise.
     * @deprecated Use {@link #setTextExtents(int,int)} instead. See the
     * deprecation comment for {@link #setTextExtentEnd(int)}
     */
    boolean setTextExtentStart (int start);

    /**
     * Returns the integer offset of this Annotation's text-extent
     * region's end anchor.
     */
    int getTextExtentEnd ();

    /**
     * Sets the integer offset of this Annotation's text-extent
     * region's end anchor to the given value.
     * Returns true if the operation was successful, false otherwise.
     * @deprecated Use {@link #setTextExtents(int,int)} instead.  If the
     ...
     */
    boolean setTextExtentEnd (int end);
     ...
     */
    boolean setTextExtents (int start, int end);
}
