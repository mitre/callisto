 ...
 * @version 1.0
 */
public class PhraseToolKit extends AbstractToolKit {
  ...
  private void initActions () {
    ...
    actions.add (new CreateTextAnnotAction ("Mention Head", task,
                                            task.getAnnotationType ("phrase-tag"),
                                            "phrase-tag.mention-head"));
    actions.add (new CreateTextAnnotAction ("Mention Extent", task,
                                            task.getAnnotationType ("phrase-tag"),
