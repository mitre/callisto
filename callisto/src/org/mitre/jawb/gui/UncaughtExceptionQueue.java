 ...
 */
public class UncaughtExceptionQueue extends EventQueue {
  public UncaughtExceptionQueue() {
  ...
  public void dispatchEvent(AWTEvent e) {
    try {
      ...
      JOptionPane.showMessageDialog(findActiveFrame(), x.toString(),
                                    "Exception Occurred", JOptionPane.OK_OPTION);
