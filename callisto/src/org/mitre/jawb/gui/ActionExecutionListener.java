...
// This interface has to do with the ActionModel, and what events
// end up getting fired.

public interface ActionExecutionListener {
  
  // Fired when an action is finished. Achieved by having
  // a proxy around each "real" action which is GUI-visible.
