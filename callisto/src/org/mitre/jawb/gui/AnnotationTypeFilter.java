...
/**
 * A simple <code>FileFilter</code>, which accepts all annotations of the
 * specified type.
 *
...
public class AnnotationTypeFilter implements AnnotationFilter {
  ...
  public AnnotationTypeFilter (AnnotationType type) {
    this.type = type;
  }
  ...
  public boolean accept(Annotation annot) {
    if (annot == null)
      return false;
    return annot.getAnnotationType ().equals (type);
  }
