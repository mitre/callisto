...
/**
 * Panel which renders a Calendar (Gregorian) and listens for user
 ...
 * subsequently modified. The following is an example of using the
 * CalendarPanel in a PopupWindow, so that users can unobtrusively set the
 ...
 *
 *  private CalendarPanel mCalendarPanel;
 ...
 *
 *    mCalendarPanel= new CalendarPanel ();
...
public class CalendarPanel extends JPanel {
  ...
  public static void main (String[] args) {
    JFrame frame = new JFrame ("CalendarPanel Test");
  ...
  private static class PopupCalendar extends JPanel {
    ...
    public PopupCalendar () {
      ...
      mCalendarPanel= new CalendarPanel (isoCalendar);
      mCalendarPanel.addPropertyChangeListener
        ("time", new PropertyChangeListener() {
            public void propertyChange (PropertyChangeEvent e) {
              popup.hide();
