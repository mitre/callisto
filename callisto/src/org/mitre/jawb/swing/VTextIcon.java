 ...
 * component which supports Icons, such as JLabel or JButton<p>
 *
 ...
 * legal for the given string (for example, Chinese/Japanese/Korean scripts
...
public class VTextIcon implements Icon, PropertyChangeListener {
  ...
  /**
   * Creates a <code>VTextIcon</code> for the specified
   * <code>component</code> with the specified <code>label</code>.  It
   * sets the orientation to the default for the string
   * @see #verifyRotation */
   ...
   * Creates a <code>VTextIcon</code> for the specified
   * <code>component</code> with the specified <code>label</code>.  It
   * sets the orientation to the provided value if it's legal for the
   * string
   * @see #verifyRotation */
  ...
  /**
   * sets the label to the given string, updating the orientation as
   * needed and invalidating the layout if the size changes
   * @see #verifyRotation */
  ...
  public void paintIcon(Component c, Graphics g, int x, int y) {
    ...
    if (fRotation == ROTATE_NONE) {
      ...
      for (int i = 0; i < fCharStrings.length; i++) {
        ...
        // yo in combinations) should draw in the top-right quadrant when
        // drawn vertically - they draw in the bottom-left normally
        int tweak;
        switch (fPosition[i]) {
   ...
   * ROTATE_RIGHT). This is public static so you can use it to test a string
   * without creating a VTextIcon.<p>
   *
   ...
   * Rotation rules<br>
   * <ul>
   *  <li>Roman can rotate left, right, or none - default right
   *      (counterclockwise)
   *  <li>CJK can't rotate
   *  <li>Arabic must rotate - default left (clockwise)
   * </ul>
   *
   ...
   * Standard...  U+4E00-U+9FFF, U+3400-U+4DFF, U+F900-U+FAFF<p>
   *     
   * Hiragana is U+3040-U+309F, katakana is U+30A0-U+30FF<p>
   *
   *
  ...
  // right quadrant: small a, i, u, e, o, tsu, ya, yu, yo, wa (katakana only)
  // ka ke
